...
// 출처: 한국은행 통화정책방향 결정회의 목록·기준금리 추이(bok.or.kr) — 수집 2026-09-10.
...
//   · 2025-07 이후 회의와 2026-07-16·2026-08-27 인상: 한은 회의목록·기준금리 추이로 확인.
// 2026-10-22 / 11-26 은 예정일이라 넣지 않았다(개최 후 추가).
export const MPC_MEETINGS_META = {
  source: "한국은행 통화정책방향 결정회의 목록·기준금리 추이 (bok.or.kr)",
  as_of: "2026-09-10",
  caveat: "2026-08-27 기준금리 2.75%→3.00% 인상 반영",
};
export const MPC_MEETINGS = [
  ...
  { date: "2026-08-27", decision: "인상", rate: 3.00 },
];
