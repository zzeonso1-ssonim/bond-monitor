...
| 탭 | 내용 |
|---|---|
| 일간 모니터링 | 시장지표 타일(KOSPI/원달러/미국채2Y/10Y) + 미국 국채 2Y·10Y 최근 1년 금리/10Y−2Y 스프레드 차트 + 시장지표 접이식 표(환율/주요지수/해외금리/상품 전 심볼 — 종가·전일비·주간변동률) + 30개 지표 요약 표(수익률·전일비, 스프레드·전일/1주/1개월/YTD). 행 클릭 시 1년 추이 차트, 수익률/스프레드/두 지표 차이(행 2개 클릭 → 커브 스프레드 bp) 토글 |
