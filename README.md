...
**주간 PDF**: 우상단 "주간 PDF" 버튼 → 현재 로드된 최신 데이터로 A4 가로 2쪽 PDF를 즉시 다운로드한다. 1쪽은 금리·주간변동, 주식/외환/해외 3개 시장 박스, 주간 수급표와 투자주체별 4주 순매수 차트로 구성한다. 2쪽은 월별 순발행 막대, 크레딧 스프레드 현재·전주·전월 비교, 만기별 상대가치·등급간 스프레드 8개 차트다. 인쇄용 화이트 Coinbase 양식이며, 통안 91일은 미적재라 제외한다.
